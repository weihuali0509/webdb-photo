...
class StoreAPicture(webapp2.RequestHandler):
  ...
  def store_a_picture(self, tag, picture):
	storePic(tag, picture)
	# call trimdb if you want to limit the size of db
	# trimdb()
  ...
  def post(self):
	...
	self.store_a_picture(tag,decoded)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            )
...
def WritePicToPhone(handler, entry):
	handler.response.headers['Content-Type'] = 'application/jsonrequest'
	json.dump(["PICTURE", entry.tag, entry.url_for()], handler.response.out)
...
def storePic(tag, picture, bCheckIfTagExists=True):
	if bCheckIfTagExists:
		# There's a potential readers/writers error here :(
		entry = db.GqlQuery("SELECT * FROM StoredPicture where tag = :1", tag).get()
		if entry:
		  entry.picture = picture
		else: entry = StoredPicture(tag = tag , picture = picture)
	else:
		entry = StoredPicture(tag = tag, picture = picture)
	entry.put()	
def trimdb():
